const testimonials = [
    {
        id: 1,
        testimonial:
            "Kartik is a joy to work with. He is hardworking and persistent, making sure to deliver the work assigned to him completely and on time. When there are things he doesn't know how to do yet, he is eager to learn and is fast on the pickup. Aside from his technical skills, he also has excellent soft skills. He deals with issues and provides constructive feedback tactfully, all while maintaining a positive outlook. Kartik is an indispensable team player and any software team will be lucky to have Kartik on the team. ",
